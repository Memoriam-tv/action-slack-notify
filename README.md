This action is a part of [GitHub Actions Library](https://github.com/Memoriam-tv/github-actions-library/) created by [Memoriam-tv](https://github.com/Memoriam-tv/).
...
<img width="485" alt="action-slack-notify-Memoriam-tv" src="https://user-images.githubusercontent.com/4115/54996943-9d38c700-4ff0-11e9-9d35-7e2c16ef0d62.png">

The `Site` and `SSH Host` details are only available if this action is run after [Deploy WordPress GitHub action](https://github.com/Memoriam-tv/action-deploy-wordpress).
...
jobs:
  slackNotification:
    ...
    - name: Slack Notification
      uses: Memoriam-tv/action-slack-notify@v2
      env:
...
SLACK_FOOTER      | Powered By Memoriam-tv's GitHub Actions Library            | Slack message footer.
...
```yml
    - name: Slack Notification
      ...
      env:
        ...
        SLACK_ICON: https://github.com/Memoriam-tv.png?size=48
        SLACK_MESSAGE: 'Post Content :rocket:'
        SLACK_TITLE: Post Title
        SLACK_USERNAME: Memoriam-tv
        SLACK_WEBHOOK: ${{ secrets.SLACK_WEBHOOK }}
```
...
[MIT](LICENSE) © 2022 Memoriam-tv

## Does this interest you?

<a href="https://Memoriam-tv.com/"><img src="https://Memoriam-tv.com/wp-content/uploads/sites/2/2019/04/github-banner@2x.png" alt="Join us at Memoriam-tv, we specialize in providing high performance enterprise WordPress solutions"></a>
