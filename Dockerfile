...
LABEL "org.opencontainers.image.source"="https://github.com/Memoriam-tv/action-slack-notify"

WORKDIR ${GOPATH}/src/github.com/Memoriam-tv/action-slack-notify
COPY main.go ${GOPATH}/src/github.com/Memoriam-tv/action-slack-notify
